    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.SET_DEFAULT, default=None)),
                ('category', models.ForeignKey(to='cfblog.Category', on_delete=models.SET_DEFAULT, default=None)),
            ],
            options={
                'ordering': ('-publish',),
