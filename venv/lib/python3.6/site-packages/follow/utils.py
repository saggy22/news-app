...
def follow_link(object):
    return reverse('follow:follow', args=[object._meta.app_label, object._meta.object_name.lower(), object.pk])

def unfollow_link(object):
    return reverse('follow:unfollow', args=[object._meta.app_label, object._meta.object_name.lower(), object.pk])

def toggle_link(object):
    return reverse('follow:toggle', args=[object._meta.app_label, object._meta.object_name.lower(), object.pk])
